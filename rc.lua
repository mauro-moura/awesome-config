...
local myawesomemenu = {
   ...
   { "Quit", function() awesome_gnome_quit() end },
}
...
globalkeys = mytable.join(
    ...
    -- X screen locker
    awful.key({ altkey, "Control" }, "l", function () awful.spawn('i3lock-fancy') end,
              {description = "lock screen", group = "hotkeys"}),
    
    awful.key({modkey, 'Control'}, 's', function() awful.spawn('shutdown now') end,
    ...
    --]]
    -- Prompt
    awful.key({ modkey }, "r", function () awful.spawn('rofi -combi-modi window,drun -show combi -modi combi,ssh -show-icons') end,
              {description = "show rofi", group = "launcher"}),
